    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rentBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                boolean rent = db.returnPlant(plant.getId());
                if (rent) {
                    Toast.makeText(PlantDetailsActivity.this, "Plant rented successfully!", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(getApplicationContext(), HomeActivity.class);
                    startActivity(intent);
                } else {
                    Toast.makeText(PlantDetailsActivity.this, "Failed to rent plant.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
